...
if __name__ == "__main__":
    seed = 46  # Change for each run if you want an ensemble
    set_seed(seed)
    ...
    for epoch in range(epochs):
        ...
        if val_acc > best_val_acc:
            ...
            patience_counter = 0
            torch.save(model.state_dict(), f"eegnet_baseline_best_seed{seed}.pth")
        else:
            patience_counter += 1
    ...
    torch.save(model.state_dict(), f"eegnet_baseline_last_seed{seed}.pth")